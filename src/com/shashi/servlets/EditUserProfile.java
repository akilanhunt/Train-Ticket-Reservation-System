...
public class EditUserProfile extends HttpServlet {
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		pw.println("<div class='tab'>" + "<table><form action='updateuserprofile' method='post' onsubmit=\"setCsrfParam('csrf')\">"
				+"<input type=\"hidden\" id=\"csrf\">"
				+ "<tr><td>User Name :</td><td><input type='text' name='username' value='" + ESAPI.encoder().encodeForHTML(ub.getMailId())
				+ "' disabled></td></tr>" + "<tr><td>First Name :</td><td><input type='text' name='firstname' value='"
				+ ESAPI.encoder().encodeForHTML(ub.getFName()) + "'></td></tr>"
				+ "<tr><td>Last Name :</td><td><input type='text' name='lastname' value='" + ESAPI.encoder().encodeForHTML(ub.getLName())
				+ "'></td></tr>" + "<tr><td>Address :</td><td><input type='text' name='address' value='" + ESAPI.encoder().encodeForHTML(ub.getAddr())
				+ "'></td></tr>" + "<tr><td>Phone No:</td><td><input type='text' name='phone' value='" + ub.getPhNo()
				+ "'></td></tr>" + "<tr><td><input type='hidden' name='mail' value='" + ESAPI.encoder().encodeForHTML(ub.getMailId()) + "'></td></tr>"
