...
public class ViewUserProfile extends HttpServlet {
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		pw.println("<div class='tab'>" + "<table>"
				+ "<tr><td>User Name :</td><td>" + ESAPI.encoder().encodeForHTML(ub.getMailId()) + "</td></tr>"
				+ "<tr><td>Password :</td><td><input type='password' disabled value='" + ESAPI.encoder().encodeForHTML(ub.getPWord()) + "'/></td></tr>"
				+ "<tr><td>First Name :</td><td>" + ESAPI.encoder().encodeForHTML(ub.getFName()) + "</td></tr>" + "<tr><td>Last Name :</td><td>"
				+ ESAPI.encoder().encodeForHTML(ub.getLName()) + "</td></tr>" + "<tr><td>Address :</td><td>" + ESAPI.encoder().encodeForHTML(ub.getAddr()) + "</td></tr>"
				+ "<tr><td>Phone No:</td><td>" + ub.getPhNo() + "</td></tr>" + "<tr><td>Mail Id :</td><td>"
				+ ESAPI.encoder().encodeForHTML(ub.getMailId()) + "</td></tr>" + "</table>" + "</div>");
